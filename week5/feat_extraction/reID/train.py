...
from model import ft_net, ft_net_dense, ft_net_IR, ft_net_NAS, ft_net_SE, ft_net_DSE, ft_net_EF4, ft_net_EF5, ft_net_EF6,PCB, CPB, ft_net_angle, ft_net_arc
...
parser.add_argument('--data_dir',default='./data/pytorch',type=str, help='training dir path')
...
parser.add_argument('--use_EF4', action='store_true', help='use Efficient-b4' )
parser.add_argument('--use_EF5', action='store_true', help='use Efficient-b5' )
parser.add_argument('--use_EF6', action='store_true', help='use Efficient-b6' )
...
def draw_curve(current_epoch):
    ...
    if current_epoch == 0:
        ax0.legend()
        ax1.legend()
    fig.savefig( os.path.join('./data/outputs',name,'train.jpg'))
...
exp_lr_scheduler = lr_scheduler.MultiStepLR(optimizer_ft, milestones=[40-start_epoch, 55-start_epoch], gamma=0.1)
...
model = train_model(model, criterion, optimizer_ft, exp_lr_scheduler,
                    start_epoch=start_epoch, num_epochs=60)
